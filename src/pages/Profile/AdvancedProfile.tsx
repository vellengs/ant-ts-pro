...
import { DescriptionList } from 'ant-ts-pro';
...
class AdvancedProfile extends Component<any, any> {
  state = {
    operationkey: 'tab1',
  ...
  componentWillUnmount() {
    ...
    (this.setStepDirection as any).cancel();
  }
    ...
    return (
      ...
      >
        <Card title="流程进度" style={{ marginBottom: 24 }} bordered={false}>
          <Steps direction={stepDirection as any} progressDot={customDot} current={1}>
