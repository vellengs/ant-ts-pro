...
class BasicList extends PureComponent<any, any> {
  ...
  render() {
    ...
    const { visible, done, current = {} }: any = this.state;
        ...
        <div className={styles.standardList}>
          <Card bordered={false}>
            <Row>
              ...
              <Col sm={8} xs={24}>
                <Info bordered={false} title="本周完成任务数" value="24个任务" />
              </Col>
            </Row>
          </Card>
